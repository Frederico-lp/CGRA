...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.textureC1 = new CGFtexture(this, 'images/mineTop.png');
        this.textureC2 = new CGFtexture(this, 'images/mineSide.png');
        this.textureC3 = new CGFtexture(this, 'images/mineSide.png');
        this.textureC4 = new CGFtexture(this, 'images/mineSide.png');
        this.textureC5 = new CGFtexture(this, 'images/mineSide.png');
        this.textureC6 = new CGFtexture(this, 'images/mineBottom.png');
